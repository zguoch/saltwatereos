...
SWIGEXPORT SEXP
R_swig_fact ( SEXP n, SEXP s_swig_copy)
{
  int result;
  int arg1 ;
...
R_swig_new_Foo ( )
{
  ...
  result = (Foo *)new Foo();
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Foo, SWIG_POINTER_OWN |  0 );
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
...
R_swig_delete_Foo ( SEXP self)
{
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Foo, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGEXPORT SEXP
R_swig_Foo_bar ( SEXP self, SEXP x, SEXP s_swig_copy)
{
  int result;
  Foo *arg1 = (Foo *) 0 ;
  int arg2 ;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGEXPORT SEXP
R_swig_Foo_x_set ( SEXP self, SEXP s_x)
{
  Foo *arg1 = (Foo *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  arg1 = reinterpret_cast< Foo * >(argp1);
  arg2 = static_cast< int >(INTEGER(s_x)[0]);
  if (arg1) (arg1)->x = arg2;
  r_ans = R_NilValue;
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
...
SWIGEXPORT SEXP
R_swig_Foo_x_get ( SEXP self, SEXP s_swig_copy)
{
  int result;
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   {"R_swig_Foo_x_set", (DL_FUNC) &R_swig_Foo_x_set, 2},
   {"R_swig_Foo_bar", (DL_FUNC) &R_swig_Foo_bar, 3},
   {"R_swig_delete_Foo", (DL_FUNC) &R_swig_delete_Foo, 1},
   {"R_swig_new_Foo", (DL_FUNC) &R_swig_new_Foo, 0},
   {"R_swig_Foo_x_get", (DL_FUNC) &R_swig_Foo_x_get, 2},
   {"R_swig_fact", (DL_FUNC) &R_swig_fact, 2},
   {NULL, NULL, 0}
};

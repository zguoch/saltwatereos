...
int main(int argc, char** argv)
{
    ...
    if (TorH == "T")
    {
        if(const_var == "X")
        {
            eos.createLUT_2D(xmin + 273.15, xmax + 273.15, ymin * 1E5, ymax * 1E5, constZ, LOOKUPTABLE_FOREST::CONST_X_VAR_TorHP, LOOKUPTABLE_FOREST::EOS_ENERGY_T, min_level, max_level, Update_prop_rho | Update_prop_h | Update_prop_T);
        ...
        {
            eos.createLUT_2D(xmin, xmax, ymin + 273.15, ymax+273.15, constZ * 1E5, LOOKUPTABLE_FOREST::CONST_P_VAR_XTorH, LOOKUPTABLE_FOREST::EOS_ENERGY_T, min_level, max_level, Update_prop_rho | Update_prop_h | Update_prop_T);
        ...
        {
            eos.createLUT_2D(xmin, xmax, ymin*1E5, ymax*1E5, constZ + 273.15, LOOKUPTABLE_FOREST::CONST_TorH_VAR_XP, LOOKUPTABLE_FOREST::EOS_ENERGY_T, min_level, max_level, Update_prop_rho | Update_prop_h | Update_prop_T);
    ...
    }else if (TorH == "H")
    {
        if(const_var == "X")
        {
            eos.createLUT_2D(xmin*1E6, xmax*1E6, ymin*1E5, ymax*1E5, constZ, LOOKUPTABLE_FOREST::CONST_X_VAR_TorHP, LOOKUPTABLE_FOREST::EOS_ENERGY_H, min_level, max_level, Update_prop_rho | Update_prop_h | Update_prop_T);
        ...
        {
            eos.createLUT_2D(xmin, xmax, ymin*1E5, ymax*1E5, constZ*1E6, LOOKUPTABLE_FOREST::CONST_TorH_VAR_XP, LOOKUPTABLE_FOREST::EOS_ENERGY_H, min_level, max_level, Update_prop_rho | Update_prop_h | Update_prop_T);

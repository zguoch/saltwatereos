% genLUT_2D.m Help file for genLUT_2D MEX file
%
% Generate 2D Adaptive Mesh Refined (AMR) LookUpTable (LUT) in TPX or HPX space.
%   genLUT_2D(xmin, xmax, ymin, ymax, constZ, const_which_var, TorH, outputFile, min_level=4, max_level=6, num_threads=1);

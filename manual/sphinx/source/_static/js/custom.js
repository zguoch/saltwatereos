...
//         // point it to the text that's in this code block
//         // add the button just after the text in the code block w/ jquery
//         // var HideShowCodebtn = '<button class="btn HideShowCodebtn" onclick="hideshow(currentId)"><img src="https://clipboardjs.com/assets/images/clippy.svg" width="13" alt="Copy to clipboard"></button>';
//         // $(this).after(HideShowCodebtn);
//         alert(currentId);

//     });
// }
// function addHideShowButtonToCode() {
//     // get all code elements
//     var allCodeBlocksElements = $("div.highlight pre");
...
//         // point it to the text that's in this code block
//         // add the button just after the text in the code block w/ jquery
//         var HideShowCodebtn = '<button class="btn HideShowCodebtn" onclick="hideshow()"><img src="https://clipboardjs.com/assets/images/clippy.svg" width="13" alt="Copy to clipboard"></button>';
//         $(this).after(HideShowCodebtn);
//         alert(currentId);
//     });
